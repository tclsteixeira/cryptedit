...
Author:
Copyright (c) 2022-2023 Tiago C. Teixeira
...
To install *Gtk* bindinds:
$ pip install PyGObject

To install *pycryptodome* library:
...
To run the app from your terminal type:
$ python3 cryptedit.py
